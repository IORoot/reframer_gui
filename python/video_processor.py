...
class VideoProcessor:
    ...
    def generate_output_video(self, output_path, crop_windows, fps=None, add_beta_watermark=False, beta_text="BETA Version", beta_position="center", beta_opacity=0.1):
